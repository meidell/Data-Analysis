...
tempGroup <- group_by(pf, age, gender)
pf.fc_by_age_gender <- summarise(tempGroup,
...
ggplot(aes(x=age, y=median_friend_count),
  data=subset(pf.pf_by_age_gender, !is.na(gender))) +
  geom_line(aes(color=gender),stat='summary',fun.y=median)
...
```{r Ratio Plot}
 ggplot(aes(x=age, y=female/male), data=pf.pf_by_age_gender.wide) +
  geom_line() +
